...
//        preloadData()
        let bundlePath = Bundle.main.path(forResource: "TrailData", ofType: "realm")!
...
//                    
//                    do {
//                                for trailName in arrayContents {
//                                    let trailObject = Trail(context: backgroundContext)
//                                    trailObject.name = trailName
//                                    trailObject.isChecked = false
//                                }
